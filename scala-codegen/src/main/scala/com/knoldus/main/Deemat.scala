...
package com.knoldus {
  package Main {
    final case class Deemat(owner: ` lfdomainapi`.Primitive.Party, broker: ` lfdomainapi`.Primitive.Party, amount: ` lfdomainapi`.Primitive.Int64, max_amount: ` lfdomainapi`.Primitive.Int64, buy_Share: ` lfdomainapi`.Primitive.Text) extends ` lfdomainapi`.Template[Deemat] {
      override protected[this] def templateCompanion(implicit ` d` : _root_.scala.Predef.DummyImplicit) = Deemat
    }

    object Deemat extends ` lfdomainapi`.TemplateCompanion[Deemat] with _root_.scala.Function5[` lfdomainapi`.Primitive.Party, ` lfdomainapi`.Primitive.Party, ` lfdomainapi`.Primitive.Int64, ` lfdomainapi`.Primitive.Int64, ` lfdomainapi`.Primitive.Text, _root_.com.knoldus.Main.Deemat] {
      ...
      final implicit class `Deemat syntax`[+` ExOn`](private val id: ` ExOn`) extends _root_.scala.AnyVal {
        ...
        def exerciseAuthorizeInvestor(actor: ` lfdomainapi`.Primitive.Party, choiceArgument: com.knoldus.Main.AuthorizeInvestor)(implicit ` exOn` : ` lfdomainapi`.encoding.ExerciseOn[` ExOn`, Deemat]): ` lfdomainapi`.Primitive.Update[` lfdomainapi`.Primitive.ContractId[com.knoldus.Main.Deemat]] = ` exercise`(id, "AuthorizeInvestor", _root_.scala.Some(` lfdomainapi`.Value.encode(choiceArgument)));
        def exerciseAuthorizeInvestor(actor: ` lfdomainapi`.Primitive.Party, investor: ` lfdomainapi`.Primitive.Party, updated_Token: ` lfdomainapi`.Primitive.Int64)(implicit ` exOn` : ` lfdomainapi`.encoding.ExerciseOn[` ExOn`, Deemat]): ` lfdomainapi`.Primitive.Update[` lfdomainapi`.Primitive.ContractId[com.knoldus.Main.Deemat]] = exerciseAuthorizeInvestor(actor, _root_.com.knoldus.Main.AuthorizeInvestor(investor, updated_Token));
        def exerciseBuyShares(actor: ` lfdomainapi`.Primitive.Party, choiceArgument: com.knoldus.Main.BuyShares)(implicit ` exOn` : ` lfdomainapi`.encoding.ExerciseOn[` ExOn`, Deemat]): ` lfdomainapi`.Primitive.Update[com.knoldus.DA.Types.Tuple2[` lfdomainapi`.Primitive.ContractId[com.knoldus.Main.Deemat], ` lfdomainapi`.Primitive.ContractId[com.knoldus.Main.Deemat]]] = ` exercise`(id, "BuyShares", _root_.scala.Some(` lfdomainapi`.Value.encode(choiceArgument)));
        def exerciseBuyShares(actor: ` lfdomainapi`.Primitive.Party, quantity: ` lfdomainapi`.Primitive.Int64, toDeematId: ` lfdomainapi`.Primitive.ContractId[com.knoldus.Main.Deemat])(implicit ` exOn` : ` lfdomainapi`.encoding.ExerciseOn[` ExOn`, Deemat]): ` lfdomainapi`.Primitive.Update[com.knoldus.DA.Types.Tuple2[` lfdomainapi`.Primitive.ContractId[com.knoldus.Main.Deemat], ` lfdomainapi`.Primitive.ContractId[com.knoldus.Main.Deemat]]] = exerciseBuyShares(actor, _root_.com.knoldus.Main.BuyShares(quantity, toDeematId));
        def exerciseArchive(actor: ` lfdomainapi`.Primitive.Party, choiceArgument: com.knoldus.DA.Internal.Template.Archive)(implicit ` exOn` : ` lfdomainapi`.encoding.ExerciseOn[` ExOn`, Deemat]): ` lfdomainapi`.Primitive.Update[` lfdomainapi`.Primitive.Unit] = ` exercise`(id, "Archive", _root_.scala.Some(` lfdomainapi`.Value.encode(choiceArgument)));
        def exerciseArchive(actor: ` lfdomainapi`.Primitive.Party)(implicit ` exOn` : ` lfdomainapi`.encoding.ExerciseOn[` ExOn`, Deemat]): ` lfdomainapi`.Primitive.Update[` lfdomainapi`.Primitive.Unit] = exerciseArchive(actor, _root_.com.knoldus.DA.Internal.Template.Archive());
        def exerciseAcceptRequest(actor: ` lfdomainapi`.Primitive.Party, choiceArgument: com.knoldus.Main.AcceptRequest)(implicit ` exOn` : ` lfdomainapi`.encoding.ExerciseOn[` ExOn`, Deemat]): ` lfdomainapi`.Primitive.Update[com.knoldus.DA.Types.Tuple2[` lfdomainapi`.Primitive.ContractId[com.knoldus.Main.Deemat], ` lfdomainapi`.Primitive.ContractId[com.knoldus.Main.Deemat]]] = ` exercise`(id, "AcceptRequest", _root_.scala.Some(` lfdomainapi`.Value.encode(choiceArgument)));
        def exerciseAcceptRequest(actor: ` lfdomainapi`.Primitive.Party, requestId: ` lfdomainapi`.Primitive.ContractId[com.knoldus.Main.ShareRequest])(implicit ` exOn` : ` lfdomainapi`.encoding.ExerciseOn[` ExOn`, Deemat]): ` lfdomainapi`.Primitive.Update[com.knoldus.DA.Types.Tuple2[` lfdomainapi`.Primitive.ContractId[com.knoldus.Main.Deemat], ` lfdomainapi`.Primitive.ContractId[com.knoldus.Main.Deemat]]] = exerciseAcceptRequest(actor, _root_.com.knoldus.Main.AcceptRequest(requestId))
      };
      ...
      override def toNamedArguments(` self` : Deemat) = ` arguments`(scala.Tuple2("owner", ` lfdomainapi`.Value.encode(` self`.owner)), scala.Tuple2("broker", ` lfdomainapi`.Value.encode(` self`.broker)), scala.Tuple2("amount", ` lfdomainapi`.Value.encode(` self`.amount)), scala.Tuple2("max_amount", ` lfdomainapi`.Value.encode(` self`.max_amount)), scala.Tuple2("buy_Share", ` lfdomainapi`.Value.encode(` self`.buy_Share)));
                      ...
                      case ` rpcvalue`.RecordField((""| "max_amount"), _root_.scala.Some(zv3)) => (` lfdomainapi`.Value.decode[` lfdomainapi`.Primitive.Int64](zv3) match {
                        case _root_.scala.Some(z3) => (` r`.fields(4) match {
                          case ` rpcvalue`.RecordField((""| "buy_Share"), _root_.scala.Some(zv4)) => (` lfdomainapi`.Value.decode[` lfdomainapi`.Primitive.Text](zv4) match {
                            case _root_.scala.Some(z4) => Some(Deemat(z0, z1, z2, z3, z4))
      ...
      override def encoding(lte: ` lfdomainapi`.encoding.LfTypeEncoding)(`view `: view[lte.Field]): lte.Out[_root_.com.knoldus.Main.Deemat] = {
        val `recordFields `: lte.RecordFields[_root_.com.knoldus.Main.Deemat] = lte.RecordFields.xmapN(lte.fields(`view `.owner), lte.fields(`view `.broker), lte.fields(`view `.amount), lte.fields(`view `.max_amount), lte.fields(`view `.buy_Share))({
          case scala.Tuple5(owner, broker, amount, max_amount, buy_Share) => _root_.com.knoldus.Main.Deemat(owner, broker, amount, max_amount, buy_Share)
        })({
          case _root_.com.knoldus.Main.Deemat(owner, broker, amount, max_amount, buy_Share) => scala.Tuple5(owner, broker, amount, max_amount, buy_Share)
        });
